...
public class MainActivity extends AppCompatActivity {
    ...
    Task<AuthResult> pendingResultTask = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        googleLoginBtn = findViewById(R.id.gogleLoginBtn);
        githubloginBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                pendingResultTask = mAuth.getPendingAuthResult();
